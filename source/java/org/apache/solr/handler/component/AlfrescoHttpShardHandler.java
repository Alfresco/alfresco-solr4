...
public class AlfrescoHttpShardHandler extends ShardHandler {

  private AlfrescoHttpShardHandlerFactory httpShardHandlerFactory;
  ...
  public AlfrescoHttpShardHandler(AlfrescoHttpShardHandlerFactory alfrescoHttpShardHandlerFactory, HttpClient httpClient) {
    this.httpClient = httpClient;
    this.httpShardHandlerFactory = alfrescoHttpShardHandlerFactory;
    completionService = alfrescoHttpShardHandlerFactory.newCompletionService();
    pending = new HashSet<>();
