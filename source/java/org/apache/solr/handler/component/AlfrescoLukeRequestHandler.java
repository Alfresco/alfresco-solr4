...
{
    private static Logger log = LoggerFactory.getLogger(AlfrescoLukeRequestHandler.class);
    ...
    public static SimpleOrderedMap<Object> getIndexInfo(DirectoryReader reader) throws IOException
    {
        ...
        indexInfo.add("version", reader.getVersion()); // TODO? Is this different then: IndexReader.getCurrentVersion(
                                                       // dir )?
